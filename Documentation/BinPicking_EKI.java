...
public class BinPicking_EKI extends RoboticsAPIApplication implements BinPicking_ITCPListener{
	...
	public static JointTorqueCondition parColisi�nJ1 = new JointTorqueCondition(JointEnum.J1, -14, 14);
	public static JointTorqueCondition parColisi�nJ2 = new JointTorqueCondition(JointEnum.J2, -10, 10); 
	public static JointTorqueCondition parColisi�nJ3 = new JointTorqueCondition(JointEnum.J3, -8, 8); 
	public static JointTorqueCondition parColisi�nJ4 = new JointTorqueCondition(JointEnum.J4, -8, 8); 
	public static JointTorqueCondition parColisi�nJ5 = new JointTorqueCondition(JointEnum.J5, -5, 5); 
	public static JointTorqueCondition parColisi�nJ6 = new JointTorqueCondition(JointEnum.J6, -4, 4); 
	public static JointTorqueCondition parColisi�nJ7 = new JointTorqueCondition(JointEnum.J7, -2, 2); 
	private static int tiempoEsperaTrasColisi�n = 1500;
	private static double sensibilidadColisi�n = 0;
