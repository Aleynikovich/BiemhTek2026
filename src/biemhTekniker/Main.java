...
public class Main extends RoboticsAPIApplication implements ConsoleServerInterface
{
        ...
        while (true)
        {
            switch (programNumber)
            {
                ...
                case 2:
                	...
                	iiwa.move(ptp(getApplicationData().getFrame("/HomeCalibration")));
                    executeCalibration();
                    programNumber = 0;
                    break;
    ...
    private void executeCalibration()
    {
        ...
        CalibrationProgram program = new CalibrationProgram(this, iiwa, smartPickingThread.getProtocol());
    ...
    private void testCalibration()
    {
        ...
        TestCalibrationProgram program = new TestCalibrationProgram(this, iiwa, smartPickingThread.getProtocol());
