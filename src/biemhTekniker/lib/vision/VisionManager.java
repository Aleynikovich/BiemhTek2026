...
public class VisionManager
{
    ...
    private final AtomicReference<VisionProgram> pendingTask;
    ...
    public VisionManager(SmartPickingThread smartPickingThread, VisionContext visionContext)
    {
        ...
        this.pendingTask = new AtomicReference<VisionProgram>(null);
    ...
    private void visionExecutorLoop()
    {
        ...
        while (running && !Thread.currentThread().isInterrupted())
        {
            try
            {
                VisionProgram task = pendingTask.get();
     ...
     */
    public void submitVisionTask(VisionProgram task)
    {
        if (taskRunning.get())
        {
