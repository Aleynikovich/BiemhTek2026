...
public class VisionDispatcher
{
    ...
    private final Map<Integer, VisionProgram> visionTasks;
    ...
    public VisionDispatcher(VisionManager visionManager)
    {
        ...
        this.visionTasks = new HashMap<Integer, VisionProgram>();
    }
     ...
     */
    public void registerVisionTask(int programNumber, VisionProgram task)
    {
    ...
    public void registerVisionTasks()
    {
        ...
        registerVisionTask(100, new LoadReferencesProgram());
        registerVisionTask(101, new IndividualVisionCommandProgram(biemhTekniker.lib.vision.SmartPickingProtocol.Command.SET_AUTO_MODE));
        registerVisionTask(102, new IndividualVisionCommandProgram(biemhTekniker.lib.vision.SmartPickingProtocol.Command.SET_CALIB_MODE));
        registerVisionTask(103, new IndividualVisionCommandProgram(biemhTekniker.lib.vision.SmartPickingProtocol.Command.CAPTURE_DATA));
        registerVisionTask(104, new IndividualVisionCommandProgram(biemhTekniker.lib.vision.SmartPickingProtocol.Command.LOCATE_CONTAINER));
        registerVisionTask(105, new IndividualVisionCommandProgram(biemhTekniker.lib.vision.SmartPickingProtocol.Command.GET_CONTAINER_POS));
        registerVisionTask(106, new IndividualVisionCommandProgram(biemhTekniker.lib.vision.SmartPickingProtocol.Command.LOCATE_PARTS));
        registerVisionTask(107, new IndividualVisionCommandProgram(biemhTekniker.lib.vision.SmartPickingProtocol.Command.GET_PART_POS));
        registerVisionTask(108, new IndividualVisionCommandProgram(biemhTekniker.lib.vision.SmartPickingProtocol.Command.GET_NEXT_PART_POS));
        registerVisionTask(109, new FullScanProgram());
    ...
    public boolean dispatch(int programNumber)
    {
        ...
        VisionProgram task = visionTasks.get(Integer.valueOf(programNumber));
        if (task == null)
        {
