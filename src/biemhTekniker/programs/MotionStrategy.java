...
public class MotionStrategy
{
    ...
    private final boolean forceLinealAproach;
     ...
     */
    public MotionStrategy(ObjectFrame tcp, boolean useAlternatePosition, boolean forceLinealAproach)
    {
        this(tcp, useAlternatePosition, null, null, false, null, false, null, forceLinealAproach);
    }
     ...
     */
    public MotionStrategy(ObjectFrame tcp, boolean useAlternatePosition, Double redundancyE1Offset, LBR robot, boolean forceLinealAproach)
    {
        this(tcp, useAlternatePosition, redundancyE1Offset, robot, false, null, false, null, forceLinealAproach);
    }
     ...
     */
    public MotionStrategy(ObjectFrame tcp, boolean useAlternatePosition, Double redundancyE1Offset, LBR robot, boolean allowZRotation, Double zRotationAngle, boolean useToolCoordinates, boolean forceLinealAproach)
    {
        this(tcp, useAlternatePosition, redundancyE1Offset, robot, allowZRotation, zRotationAngle, useToolCoordinates, null, forceLinealAproach);
    }
     ...
     */
    public MotionStrategy(ObjectFrame tcp, boolean useAlternatePosition, Double redundancyE1Offset, LBR robot, boolean allowZRotation, Double zRotationAngle, boolean useToolCoordinates, CartesianImpedanceControlMode impedanceMode, boolean forceLinealAproach)
    {
        this.tcp = tcp;
        ...
        this.forceLinealAproach = forceLinealAproach;
    }
     ...
     */
    public boolean executeMotion(Frame targetPosition, Object approachOffset, MotionAction action, RobotContext context, boolean forceLinealApproach)
    {
