...
public class RobotCartesianPositionIOGroup extends AbstractIOGroup
{
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'Y'
	 */
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'Z'
	 */
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'A'
	 */
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'B'
	 */
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'C'
	 */
