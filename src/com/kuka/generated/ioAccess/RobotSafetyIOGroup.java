 ...
 * ./.
 */
@Singleton public class RobotSafetyIOGroup extends AbstractIOGroup
{
    /**
     * Constructor to create an instance of class 'RobotSafety'.<br>
     * <i>This constructor is automatically generated. Please, do not modify!</i>
     *
     * @param controller the controller, which has access to the I/O group 'RobotSafety'
     */
    @Inject public RobotSafetyIOGroup(Controller controller)
    {
        ...
        addDigitalOutput("ModeT2", IOTypes.BOOLEAN, 1);
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'IsLocalEStop'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'IsExternalEStop'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'IsOperatorSafety'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'IsSafetyStopActive'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'ModeT1'
     */
    ...
    /**
     * Gets the value of the <b>digital output '<i>ModeT2</i>'</b>.<br>
     * <i>This method is automatically generated. Please, do not modify!</i>
     * <p>
     * <b>I/O direction and type:</b><br>
     * digital output
     ...
     * [false; true]
     *
     * @return current value of the digital output 'ModeT2'
     */
    public boolean getModeT2()
    {
        return getBooleanIOValue("ModeT2", true);
    }

    /**
     * Sets the value of the <b>digital output '<i>ModeT2</i>'</b>.<br>
     * <i>This method is automatically generated. Please, do not modify!</i>
     * <p>
     * <b>I/O direction and type:</b><br>
     * digital output
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'ModeT2'
     */
    public void setModeT2(java.lang.Boolean value)
    {
        setDigitalOutput("ModeT2", value);
    }
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'MoveEnable'
     */
