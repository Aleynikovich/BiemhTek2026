 ...
 */
@Singleton
public class VisionStateIOGroup extends AbstractIOGroup
{
	/**
	 ...
	 *
	 * @param controller
	 *            the controller, which has access to the I/O group 'VisionState'
	 */
	@Inject
	public VisionStateIOGroup(Controller controller)
	{
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'VisionServerOnline'
	 */
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'ReferencesLoaded'
	 */
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'NewWorkpieceFound'
	 */
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'VisionServerBusy'
	 */
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'CameraModeRun'
	 */
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'CameraModeCalibration'
	 */
