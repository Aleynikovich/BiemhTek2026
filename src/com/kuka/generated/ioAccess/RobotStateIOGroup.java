...
public class RobotStateIOGroup extends AbstractIOGroup
{
	 ...
	 *
	 * @param controller
	 *            the controller, which has access to the I/O group 'RobotState'
	 */
	@Inject
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'IsInHome'
	 */
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'IsMastered'
	 */
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'IsReadyToMove'
	 */
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'HasActiveMotion'
	 */
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'IsReferenced'
	 */
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'IsGMSReferenced'
	 */
