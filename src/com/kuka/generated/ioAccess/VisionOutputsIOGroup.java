 ...
 * ./.
 */
@Singleton public class VisionOutputsIOGroup extends AbstractIOGroup
{
    /**
     * Constructor to create an instance of class 'VisionOutputs'.<br>
     * <i>This constructor is automatically generated. Please, do not modify!</i>
     *
     * @param controller the controller, which has access to the I/O group 'VisionOutputs'
     */
    @Inject public VisionOutputsIOGroup(Controller controller)
    {
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'DataRequestSent'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'PickPositionReady'
     */
     ...
     * [false; true]
     *
     * @param value the value, which has to be written to the digital output 'CalibrationComplete'
     */
