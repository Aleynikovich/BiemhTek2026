...
public class RobotJointPositionIOGroup extends AbstractIOGroup
{
	 ...
	 *
	 * @param controller
	 *            the controller, which has access to the I/O group 'RobotJointPosition'
	 */
	@Inject
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'A1'
	 */
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'A2'
	 */
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'A3'
	 */
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'A4'
	 */
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'A5'
	 */
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'A6'
	 */
	 ...
	 *
	 * @param value
	 *            the value, which has to be written to the digital output 'A7'
	 */
